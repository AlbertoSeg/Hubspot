...
$fotocasa_url_contacts = 'https://api.fotocasa.es/Contacts/Contacts'; // URL de la API de Fotocasa
$platform_channel = 'platform-fotocasa-request'; // Valor que se utilizará como contact_channel
$owner_id = '22511094'; // Es el ID de usuario de Hubspot que será quien escriba las notas en los contactos, el ID actual es de Clara
